...
/*
 * l33t sp34k version of puts. We infect PLTGOT entry for puts() of infected binaries.
 */
...
//我们依赖ASLR来获得我们的PSUEDO随机性，因为RSP在每次执行时都是不同的
